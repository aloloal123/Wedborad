    ...
    <div class="container-lg">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                ...
                <div class='card-header bg-info text-white'>ความคิดเห็น $num </div>
                <div class='card-body'>$row[content]<br><br>$row[2] - $row[1] 
                </div></div>";
                $num++;
                }
                $conn = null;
                        ...
                        <form action="post_save.php" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-12 d-flex justify-content-center">
                                    ...
                                    <button type="reset" class="btn btn-danger btn-s ms-2"><i class="bi bi-x-square"></i> ยกเลิก</button>
                                </div>
                            </div>
                        </form>
                    </div>
